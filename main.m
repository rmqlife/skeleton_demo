...
% build agents, map
%[im,agents_position,agent_radius,targets_position] = build_agents_map('screenshots/.png', 1, 0);
[im,agents_position,agent_radius,targets_position] = build_agents_map('data/liang5.png', 0, show_fag);
